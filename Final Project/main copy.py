...
d1, d2, d3, d4, d5, avg_e1, avg_e2, avg_e3, avg_e4, avg_e5, avg_k1, avg_k2, avg_k3, avg_k4, avg_k5, e1, e2, e3, e4, e5, k1, k2, k3, k4, k5 = [
    3, 2, 2, 2, 2, 3, 3, 3, 6, 2, 5, 7, 7, 7, 5, 2, 4, 4, 4, 2, 3, 3, 3, 5, 5]
...
if not error:
    ...
    np.save('0710006.npy', best_acc_array)
